...
const debug = require('debug')('run-petstore');
const NuClient = require('./src/nu-client');

const petstoreTest = require('./samples/petstore-test.json');
//debug('env is  %o', process.env);

const client = new NuClient({specs: 'http://localhost:8080/api-docs'});
//const client = new NuClient({specs: 'http://localhost:8080/api-docs', env: 'browser'});
